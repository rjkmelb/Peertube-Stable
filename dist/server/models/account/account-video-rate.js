...
let AccountVideoRateModel = AccountVideoRateModel_1 = class AccountVideoRateModel extends sequelize_typescript_1.Model {
    ...
    static loadLocalAndPopulateVideo(rateType, accountName, videoId, transaction) {
        const options = {
            where: {
                videoId,
                type: rateType
...
__decorate([
    ...
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.STRING(initializers_1.CONSTRAINTS_FIELDS.VIDEO_RATES.URL.max)),
    __metadata("design:type", String)
