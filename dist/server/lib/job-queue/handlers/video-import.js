        ...
        try {
            ...
            if (options.downloadThumbnail) {
                if (options.thumbnailUrl) {
                    ...
                    yield requests_1.downloadImage(options.thumbnailUrl, destThumbnailPath, initializers_1.THUMBNAILS_SIZE);
                }
                else {
            ...
            if (options.downloadPreview) {
                if (options.thumbnailUrl) {
                    ...
                    yield requests_1.downloadImage(options.thumbnailUrl, destPreviewPath, initializers_1.PREVIEWS_SIZE);
                }
                else {
