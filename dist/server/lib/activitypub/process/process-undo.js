...
function processUndoLike(byActor, activity) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return initializers_1.sequelizeTypescript.transaction((t) => __awaiter(this, void 0, void 0, function* () {
            ...
            let rate = yield account_video_rate_1.AccountVideoRateModel.loadByUrl(likeActivity.id, t);
            if (!rate)
                rate = yield account_video_rate_1.AccountVideoRateModel.load(byActor.Account.id, video.id, t);
            if (!rate)
...
function processUndoDislike(byActor, activity) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return initializers_1.sequelizeTypescript.transaction((t) => __awaiter(this, void 0, void 0, function* () {
            if (!byActor.Account)
                throw new Error('Unknown account ' + byActor.url);
            let rate = yield account_video_rate_1.AccountVideoRateModel.loadByUrl(dislike.id, t);
            if (!rate)
                rate = yield account_video_rate_1.AccountVideoRateModel.load(byActor.Account.id, video.id, t);
            if (!rate)
                throw new Error(`Unknown rate by account ${byActor.Account.id} for video ${video.id}.`);
