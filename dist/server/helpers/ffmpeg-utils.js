...
function computeResolutionsToTranscode(videoFileHeight) {
    ...
    const configResolutions = constants_1.CONFIG.TRANSCODING.RESOLUTIONS;
    const resolutions = [
...
function transcode(options) {
    return new Promise((res, rej) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (constants_1.CONFIG.TRANSCODING.THREADS > 0) {
                command = command.outputOption('-threads ' + constants_1.CONFIG.TRANSCODING.THREADS);
            }
            if (options.resolution !== undefined) {
