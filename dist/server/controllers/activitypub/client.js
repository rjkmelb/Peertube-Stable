...
activityPubClientRouter.get('/accounts?/:name/likes/:videoId', middlewares_1.executeIfActivityPub(middlewares_1.asyncMiddleware(validators_1.getAccountVideoRateValidator('like'))), middlewares_1.executeIfActivityPub(getAccountVideoRate('like')));
activityPubClientRouter.get('/accounts?/:name/dislikes/:videoId', middlewares_1.executeIfActivityPub(middlewares_1.asyncMiddleware(validators_1.getAccountVideoRateValidator('dislike'))), middlewares_1.executeIfActivityPub(getAccountVideoRate('dislike')));
...
activityPubClientRouter.get('/videos/watch/:id/announces/:actorId', middlewares_1.executeIfActivityPub(middlewares_1.asyncMiddleware(middlewares_1.videosShareValidator)), middlewares_1.executeIfActivityPub(middlewares_1.asyncMiddleware(videoAnnounceController)));
...
function getAccountVideoRate(rateType) {
    return (req, res) => {
        ...
        const APObject = rateType === 'like'
            ...
            : send_create_1.buildCreateActivity(url, byActor, send_1.buildDislikeActivity(url, byActor, accountVideoRate.Video));
...
function videoController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (video.url.startsWith(initializers_1.CONFIG.WEBSERVER.URL) === false)
...
function videoAnnounceController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (share.url.startsWith(initializers_1.CONFIG.WEBSERVER.URL) === false)
...
function videoCommentController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (videoComment.url.startsWith(initializers_1.CONFIG.WEBSERVER.URL) === false)
...
function videoRedundancyController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (videoRedundancy.url.startsWith(initializers_1.CONFIG.WEBSERVER.URL) === false)
...
function actorFollowing(req, actor) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return activitypub_1.activityPubCollectionPagination(initializers_1.CONFIG.WEBSERVER.URL + req.path, handler, req.query.page);
    });
}
