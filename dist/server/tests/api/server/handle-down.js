...
describe('Test handle downs', function () {
    ...
    it('Should send an update to server 3, and automatically fetch the video', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield utils_1.updateVideo(servers[0].url, servers[0].accessToken, missedVideo1.uuid, {});
            yield utils_1.updateVideo(servers[0].url, servers[0].accessToken, unlistedVideo.uuid, {});
            yield jobs_1.waitJobs(servers);
